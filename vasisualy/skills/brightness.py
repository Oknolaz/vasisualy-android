...
increase = ("Добавь яркости", "добавь яркости", "Увеличь яркость", "увеличь яркость", "Добавить яркости",
            "добавить яркости", "Увеличить яркость", "увеличить яркость", "Усиль яркость", "усиль яркость",
            "Усилить яркость", "усилить яркость")
decrease = ("Уменьши яркость", "уменьши яркость", "Убавь яркость", "убавь яркость", "Уменьшить яркость",
            "уменьшить яркость", "Убавить яркость", "убавить яркость", "Меньше яркости", "меньше яркости",
            "Минимум яркости", "минимум яркости")
